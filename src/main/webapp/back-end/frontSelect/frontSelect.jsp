	...
	<section class="scontainer-fluid my-14">
		<div class="section-content text-center ">
				...
				<div class="d-none d-md-block">
					<div class="btn-group" id="btg">
						<div class="radio-buttons-group border-0 "
							data-toggle="shuffle-grid" data-target="#projects-grid">
							<button class="btn btn-light selected fs-4 bg-cyan-30 "
			...
			<div
				...
				<!--店家查詢-->
				<div class="shuffle-grid-item hiddenBtn" data-groups="store"
				...
				<!--訂單查詢-->
				<div class="shuffle-grid-item hiddenBtn" data-groups="order"
					...
					<section>
						<div class="container col-lg-10">
							<div class=" col-12 justify-content-center">
								...
								List<Order> orderList = orderSvc.getByMemId(memId);
